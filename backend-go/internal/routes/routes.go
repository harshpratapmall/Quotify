...
func SetupRouter() *gin.Engine {
	...
	v1 := api.Group("/v1")
	{
		...
		v1.GET("/employees/attendance", handlers.ListEmployeeAttendance)
		...
		v1.PUT("/employees/:id/attendance/:date", handlers.SaveEmployeeAttendance)
		v1.DELETE("/employees/:id/attendance/:date", handlers.ClearEmployeeAttendance)
