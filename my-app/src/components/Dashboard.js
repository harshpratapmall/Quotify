    ...
    <div className="app-shell workspace-shell">
      ...
      <div className="dashboard-layout">
        <aside className="dashboard-sidebar" aria-label="Workspace navigation">
          ...
          <button type="button" className={`sidebar-link ${pathname === APP_ROUTES.employees ? 'active' : ''}`} onClick={() => navigate(APP_ROUTES.employees)}><ActionIcon type="profile" /> Employees</button>
